# ТЕХНИЧЕСКОЕ ЗАДАНИЕ
### Быстрый старт: переменные окружения для прод/стейджинг

Для корректной работы админки и приложения по IP/домену, добавьте в `.env`:

```
DEBUG=False
ALLOWED_HOSTS=localhost,127.0.0.1,0.0.0.0
ALLOWED_HOSTS_EXTRA=10.0.21.221
```

Можно перечислить несколько значений через запятую в `ALLOWED_HOSTS_EXTRA`.
...
- [API документация](API_ДОКУМЕНТАЦИЯ.md) - Полное описание REST API
- [Архитектура](АРХИТЕКТУРА.md) - Архитектура системы и компоненты
- [Разработка](РАЗРАБОТКА.md) - Настройка среды разработки
- [Развертывание](РАЗВЕРТЫВАНИЕ.md) - Инструкции по развертыванию
- [Тестирование](ТЕСТИРОВАНИЕ.md) - Стратегия тестирования
- [Устранение неполадок](УСТРАНЕНИЕ_НЕПОЛАДОК.md) - Решения проблем
- [Современные практики](СОВРЕМЕННЫЕ_ПРАКТИКИ.md) - Лучшие практики разработки
- [Обновления](ОБНОВЛЕНИЯ.md) - Автоматические и ручные обновления
